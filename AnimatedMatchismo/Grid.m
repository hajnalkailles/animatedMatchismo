...
/*- (NSString *)description
{
    ...
    if (!self.rowCount) {
        ...
        description = [description stringByAppendingFormat:@"%luc x %lur at %d each", (unsigned long)self.columnCount, (unsigned long)self.rowCount, NSStringFromCGSize(self.cellSize)];
    }
